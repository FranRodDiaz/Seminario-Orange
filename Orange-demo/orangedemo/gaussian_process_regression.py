...
from Orange.regression import SklLearner   # importamos la clase SklLearner de Orange para contruir y entrenar modelo de regresion
...
class _FeatureScorerMixin(LearnerScorer):
    ...
    class_type = ContinuousVariable #Representa la clase de salida, con la que se realizarán las predicciones.
